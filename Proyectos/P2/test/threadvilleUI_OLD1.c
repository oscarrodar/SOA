...
int main (int argc, char *argv[])
{
  GtkWidget *window;
  GtkWidget *filemenu;
  GtkWidget *agregarVehiculo;
  GtkWidget *configurarBus;
  ...
  agregarVehiculo = gtk_menu_item_new_with_label("Agregar vehiculo");
  configurarBus = gtk_menu_item_new_with_label("Configurar buses");
